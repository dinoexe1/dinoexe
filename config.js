...
module.exports = {
    ...
    SESSION: process.env.DINO BOT  ❌_CODE === undefined ? '' : process.env.DINO BOT  ❌_CODE,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By DINO BOT  ❌' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '994408993612@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    MAHN: "+994408993612,0",
    SUPPORT: "+994408993612-1635775355",
    SUPPORT2: "+994408993612-1617736751",
    SUPPORT3: "+994408993612-1621015274"
};
